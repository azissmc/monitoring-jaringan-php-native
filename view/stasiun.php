...
<div class="tab-content">
  ...
  <div class="tab-pane" id="stasiun-info">
    ...
    <div class="panel-body">
        <ul>
            <li>Nama DC : <strong><?php echo $name_blok; ?></strong></li>
            <li>Alamat : <strong><?php echo $add_blok; ?></strong></li>
            <li>Telp : <strong>+<?php echo $telp_blok; ?></strong></li>
            <li>Jumlah Network : <strong><?php echo $total_pc; ?> Network/PC</strong></li>
        </ul>
    </div>
  </div><!-- /.tab-pane -->
    ...
    echo '<div class="col-md-12">
              <div class="box box-solid">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Daftar DC</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <ul class="list-unstyled" style="margin-left:10px;">';
        while ($get = $query->fetch_assoc()) {
            extract($get);
            echo "<li><a href='./stasiun&id=$id_blok'><h5><i class='fa fa-globe'></i>&nbsp;&nbsp; $name_blok</h5></a></li>";
            echo '';
        }
    echo"</ul>
                </div><!-- /.box-body -->
