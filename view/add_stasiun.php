                  ...
                  <div class="active tab-pane">
                    ...
                    <div class="post">
                      ...
                      <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">Nama DC</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <div class="input-group-addon">
                              <i class="fa fa-globe"></i>
                            </div>
                            <input type="text" class="form-control" name="name_st" placeholder="Nama DC" required>
                          </div><!-- /.input group -->
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" name="add_st" rows='10' placeholder='Alamat DC' required></textarea>
                        </div>
                      </div>
