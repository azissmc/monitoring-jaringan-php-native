...
function sendMail($x) {     
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'nellakarisma1688@gmail.com'; // Email anda disini
    $mail->Password = 'Ganteng12!'; // Katasandi email anda
    $mail->SMTPSecure = 'tls';
     
    $mail->From = 'nellakarisma1688@gmail.com'; // Email disamakan saja
    $mail->FromName = 'Monitoring GSD';
    $mail->addAddress('suprastiyadanang@gmail.com', 'GSD Monitoring'); // Target email
     
    $mail->addReplyTo('nellakarisma1688@gmail.com', 'Monitoring GSD'); // isi saja sama seperti email yg anda gunakan untuk mengirim
